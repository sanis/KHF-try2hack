...
if (isset($_POST['login'])) {
    if ($_POST['login']=='three' && $_POST['password']=='gmailas') {
        session_start();
        header('location: level5.php');
    } else {
        header('location: level4.php?success=0');
    }
}
...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Sign in to go to next level (now 4)</h1>
            ...
            <div class="account-wall">
                ...
                <form class="form-signin" id="login-form" method="post" action="level4.php">
